    ...
    <main>
        <main class="flex-container">
          ...
          <div class="profile-card">
            <img src="{{ asset('assets/images/profileicon.png') }}" alt="profile" class="profile-picture">
            ...
            <div class="progress-bars">
              <div class="progress-container">
                ...
                <div class="progress-box">
                  <label for="css">Cascading Style Sheet<span class="percent">45%</span></label>
                  <progress id="css" class="progress-bar" value="32" max="100">32</progress>
                </div>
                <div class="progress-box">
                  <label for="css">HyperText Markup Language<span class="percent">100%</span></label>
                  <progress id="css" class="progress-bar" value="100" max="100">32</progress>
                </div>
                <div class="progress-box">
                  <label for="css">Javascript<span class="percent">70%</span></label>
                  <progress id="css" class="progress-bar" value="80" max="100">32</progress>
                </div>
                <div class="progress-box">
                  <label for="css">PHP<span class="percent">45%</span></label>
                  <progress id="css" class="progress-bar" value="32" max="100">32</progress>
                </div>
                <div class="progress-box">
                  <label for="css">Python<span class="percent">60%</span></label>
              ...
              <div class="progress-container">
                ...
                <div class="progress-box">
                  <label for="css">Cascading Style Sheet<span class="percent">40%</span></label>
                  <progress id="css" class="progress-bar" value="32" max="100">32</progress>
                </div>
                <div class="progress-box">
                  <label for="css">HyperText Markup Language<span class="percent">50%</span></label>
                  <progress id="css" class="progress-bar" value="50" max="100">32</progress>
                </div>
                <div class="progress-box">
                  <label for="css">Javascript<span class="percent">60%</span></label>
                ...
                <div class="progress-box">
                  <label for="css">Python<span class="percent">90%</span></label>
                  <progress id="css" class="progress-bar" value="90" max="100">32</progress>
                </div>
                <div class="progress-box">
                  <label for="css">SQL<span class="percent">100%</span></label>
                  <progress id="css" class="progress-bar" value="100" max="100">32</progress>
                </div>
              </div>
            </div>
