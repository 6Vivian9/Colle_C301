...
<div class="dropdown">
    ...
    <main>
      <nav>
      <div class="content">
    <p><a href="library">library</a> > <a href="pyeasy">Python Easy Module</a> > <a href="quizpythoneasy">Python Easy Quiz</a></p>
  </div>
        <div class="flex-container">
          ...
          <form id="quizForm">
    <div>
      <h1 style="text-align:center;">PYTHON EASY QUIZ</h1>
      <br>
        <ol>
