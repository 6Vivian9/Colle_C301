...
<html lang="en">
  ...
  <body>
    ...
    <main>
      <nav>
      <div class="content">
    <p><a href="library">library</a> > <a href="pyhard">Python Hard Module</a> > <a href="quizpythonhard">Python Hard Quiz</a></p>
  </div>
        <div class="flex-container">
          ...
          <form id="quizForm">
    <div>
      <h1 style="text-align:center;">PYTHON HARD QUIZ</h1>
      <br>
        <ol>
